...
class TwoLayerNet(object):
  ...
  def __init__(self, input_dim=3*32*32, hidden_dim=100, num_classes=10,
    ...
    """
    self.params = {}
    self.reg = reg # value for regularization
...
class FullyConnectedNet(object):
  ...
  def __init__(self, hidden_dims, input_dim=3*32*32, num_classes=10,
    ...
    self.reg = reg
    self.num_layers = 1 + len(hidden_dims) # Y??
    self.dtype = dtype
    self.params = {}
  ...
  def loss(self, X, y=None):
    ...
    ############################################################################
    pass
    hidden_layers, caches = list(range(self.num_layers + 1)), list(range(self.num_layers)) #Alter point
    ...
    pass
    loss, dscores = softmax_loss(scores, y)
    dhiddens = list(range(self.num_layers + 1)) # Alter point
